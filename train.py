...
config_dataset = BaseDatasetConfig(
        ...
        meta_file_train="/content/dataset/metadata_train.csv",
        meta_file_val="/content/dataset/metadata_eval.csv",
        language="en",
    )
...
# SPEAKER_REFERENCE = [
#     "/tmp/xtts_ft/dataset/refence.wav"  # speaker reference to be used in training test sentences
# ]
